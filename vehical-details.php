      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <textarea rows="4" class="form-control" name="message" placeholder="Proposition" required></textarea>
            </div>
...
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login For Book</a>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-envelope" aria-hidden="true"></i>Pay Now</h5>
          </div>
          <form method="post">
            <div class="form-group">
              <input type="date" class="form-control" name="fromdate" placeholder="From Date(dd/mm/yyyy)" required>
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login For Paying</a>
